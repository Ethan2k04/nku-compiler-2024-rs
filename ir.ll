...
bb_4:
	%v32 = alloca float
	%v35 = sitofp i32 %v30 to float
	%v36 = fmul float 0x400921FB60000000, %v35
	%v38 = sitofp i32 %v30 to float
...
bb_31:
	...
	%v179 = fmul float 0x400921FB60000000, %v175
	%v181 = fmul float %v179, %v175
	%v184 = fptosi float %v175 to i32
	...
	%v194 = fadd float %v192, %v175
	store float %v194, ptr %v188
	call void @putfloat(float %v181)
	call void @putch(i32 32)
	%v198 = fptosi float %v185 to i32
