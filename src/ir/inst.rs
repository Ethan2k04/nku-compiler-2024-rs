...
impl Inst {
    ...
    pub fn int_binary(
        ...
        let inst = Self::new(ctx, InstKind::IntBinary { op: op_ty }, ty);
        inst.add_operand(ctx, lhs);
        inst.add_operand(ctx, rhs);
        inst
    }
    ...
    pub fn float_binary(
        ...
        let inst = Self::new(ctx, InstKind::FloatBinary { op: op_ty }, ty);
